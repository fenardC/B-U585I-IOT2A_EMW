...
WiFiNetworkStation::~WiFiNetworkStation(void) noexcept
{
  ...
  static_cast<void>(::WiFiNetworkCore::emwPtr->unRegisterStatusCallback(EmwApiBase::eSTATION));
...
std::int32_t WiFiNetworkStation::activateImp(const char (&ssidString)[33], const char (&passwordString)[65]) noexcept
{
  ...
  if (EmwApiBase::eEMW_STATUS_OK \
      != ::WiFiNetworkCore::emwPtr->registerStatusCallback(&WiFiNetworkStation::EmwStatusChanged,
          this, EmwApiBase::eSTATION)) {
    LWIP_ASSERT("Registering to the Wi-Fi module failed", false);
    status = -1;
  }
  else if (EmwApiBase::eEMW_STATUS_OK != this->WiFiNetworkCore::emwPtr->getStationMacAddress(mac_address_48bits)) {
    ...
    static_cast<void>(this->WiFiNetworkCore::emwPtr->connect(ssidString, passwordString,
...
std::int32_t WiFiNetworkStation::deActivateImp(void) noexcept
{
  ...
  static_cast<void>(::WiFiNetworkCore::emwPtr->disconnect());
