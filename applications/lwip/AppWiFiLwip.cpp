...
{
  static const ip_addr_t IP_ADDRESS_FIXED = IPADDR4_INIT(lwip_htonl(this->makeU32(10U, 10U, 10U, 1U)));
  static const ip_addr_t NETWORK_MASK = IPADDR4_INIT(lwip_htonl(this->makeU32(255U, 255U, 255U, 0U)));
...
{
  static const ip_addr_t IP_ADDRESS_FIXED = IPADDR4_INIT(lwip_htonl(this->makeU32(192, 168, 1, 113)));
  static const ip_addr_t NETWORK_MASK = IPADDR4_INIT(lwip_htonl(this->makeU32(255U, 255U, 254U, 0U)));
