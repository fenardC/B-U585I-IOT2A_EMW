...
class EmwNetworkStack final {
  ...
  public:
    static std::uint8_t *GetBufferPayload(EmwNetworkStack::Buffer_t *networkPacketPtr, uint32_t &size) noexcept;
  public:
    static std::uint32_t GetBufferPayloadSize(const EmwNetworkStack::Buffer_t *networkPacketPtr) noexcept;
  public:
