...
void AppHttpSSE::doAcceptService(void *argPtr) noexcept
{
  ...
  try {
    ...
    }
    {
      ...
      if (0 <= lwip_getpeername(peer.sock, reinterpret_cast<struct sockaddr *>(&sock_address_name_in),
                                &sock_addr_name_in_size)) {
...
void AppHttpSSE::doListenService(void) noexcept
{
  ...
  try {
    ...
    }
    {
      ...
      if (0 != lwip_bind(sock, reinterpret_cast<struct sockaddr *>(&sock_address_in), sizeof(sock_address_in))) {
