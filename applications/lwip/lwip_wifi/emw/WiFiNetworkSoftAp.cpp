...
WiFiNetworkSoftAp::~WiFiNetworkSoftAp(void) noexcept
{
  ...
  static_cast<void>(EmwBypass.unRegisterStatusCallback(EmwApiBase::eSOFTAP));
...
std::int32_t WiFiNetworkSoftAp::activateImp(const char (&ssidString)[33], const char (&passwordString)[65]) noexcept
{
  ...
  if (EmwBypass.registerStatusCallback(&WiFiNetworkSoftAp::EmwStatusChanged,
                                       this, EmwApiBase::eSOFTAP) != EmwApiBase::eEMW_STATUS_OK) {
    ...
    static_cast<void>(EmwBypass.startSoftAp(access_point_settings));
    {
  ...
  if (EmwBypass.getSoftApMacAddress(mac_address_48bits) != EmwApiBase::eEMW_STATUS_OK) {
...
std::int32_t WiFiNetworkSoftAp::deActivateImp(void) noexcept
{
  ...
  static_cast<void>(EmwBypass.stopSoftAp());
