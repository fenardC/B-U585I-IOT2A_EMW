...
#if defined(COMPILATION_WITH_FREERTOS)
  {
    static const char main_task_name[] = {"MainTask"};

    static_cast<void>(xTaskCreate(FreeRtosMainTask, main_task_name, 1024U, nullptr, 16U, NULL));
  }
#endif /* COMPILATION_WITH_FREERTOS) */
}
...
static void FreeRtosMainTask(void *argumentPtr)
{
  ...
  InitializeEmw(EmwBypass);
  WiFiNetworkCore::InitializeSystem();
