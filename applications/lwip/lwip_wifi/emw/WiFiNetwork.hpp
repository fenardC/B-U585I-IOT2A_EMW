...
class WiFiNetwork final {
  public:
    explicit WiFiNetwork(EmwApiBase::EmwInterface interface, struct netif &aNetif);
  public:
    ~WiFiNetwork(void);
  public:
    typedef struct {
  ...
  public:
    char deviceIdentifierString[64 + 1];
  public:
    char deviceNameString[64 + 1];
  public:
  ...
  private:
    static void inputFromDriver(void *bufferPtr, void *argPtr);
  private:
    static void inputNetif(struct netif &aNetif, struct pbuf *bufferPtr);
  private:
