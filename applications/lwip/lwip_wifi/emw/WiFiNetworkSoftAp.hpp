...
class WiFiNetworkSoftAp final : public WiFiNetworkInterface<WiFiNetworkSoftAp>, protected WiFiNetworkCore {
  public:
  ...
  public:
    explicit WiFiNetworkSoftAp(struct netif &netif) noexcept;
  public:
    explicit WiFiNetworkSoftAp(const WiFiNetworkSoftAp &other) = delete;
  public:
    ~WiFiNetworkSoftAp(void) noexcept override;
  public:
  ...
  private:
    static class WiFiNetworkSoftAp *MySelf(struct netif *netifPtr) noexcept;
  private:
