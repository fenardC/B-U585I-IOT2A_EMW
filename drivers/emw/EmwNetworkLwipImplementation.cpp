...
void EmwNetworkStack::FreeBuffer(EmwNetworkStack::Buffer_t *networkPacketPtr) noexcept
{
  ...
  static_cast<void>(pbuf_free(networkPacketPtr));
...
std::uint8_t *EmwNetworkStack::GetBufferPayload(EmwNetworkStack::Buffer_t *networkPacketPtr, uint32_t &size) noexcept
{
  size = static_cast<std::uint32_t>(networkPacketPtr->len);
  return static_cast<std::uint8_t *>(networkPacketPtr->payload);
}

std::uint32_t EmwNetworkStack::GetBufferPayloadSize(const EmwNetworkStack::Buffer_t *networkPacketPtr) noexcept
{
...
void EmwNetworkStack::HideBufferHeader(EmwNetworkStack::Buffer_t *networkPacketPtr) noexcept
{
  ...
  static_cast<void>(pbuf_header(networkPacketPtr, - size));
}
