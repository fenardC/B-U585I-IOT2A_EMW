...
class EmwApiCore : protected /*private*/ EmwCoreIpc {
  ...
  public:
    static const char *productIdentifier;
  public:
    static const char *getConfigurationString(void) noexcept;
  public:
    void getStatistics(void) noexcept;
  public:
  ...
  public:
    typedef struct MacAddress_s {
      constexpr MacAddress_s(void) noexcept : bytes{0U, 0U, 0U, 0U, 0U, 0U} {}
      std::uint8_t bytes[6];
    } MacAddress_t;
  public:
  ...
  private:
    struct SystemInformations_s {
      constexpr SystemInformations_s(void) noexcept
        : firmwareRevision {"V0.0.0"}, mac48bitsSoftAp{0U, 0U, 0U, 0U, 0U, 0U}, mac48bitsStation{0U, 0U, 0U, 0U, 0U, 0U} {}
  ...
  private:
    std::uint32_t timeoutInMsForIPC;
  ...
  private:
    static volatile std::uint8_t interfaces;
  private:
