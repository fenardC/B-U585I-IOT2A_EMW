  ...
  public:
    struct Stm32Hw_s {
      Stm32Hw_s(void)
        ...
        , hExtiFlowPtr(nullptr), hFlowPortPtr(nullptr), flowPin(0U), flowIrq((IRQn_Type)0)
        , hExtiNotifyPtr(nullptr), hNotifyPortPtr(nullptr), notifyPin(0U), notifyIrq((IRQn_Type)0)
