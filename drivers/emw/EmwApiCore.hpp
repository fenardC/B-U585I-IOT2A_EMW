...
class EmwApiCore {
  ...
  public:
    EmwApiBase::Status getIP6Address(uint8_t *ip6AddressPtr, uint8_t addressSlot,
    ...
    struct SystemInformations_s {
      SystemInformations_s(void)
        : productName{"MXCHIP-WIFI"}, productIdentifier{"EMW3080B"}, firmwareRevision{"V0.0.0"},
          mac48bitsAp{0U, 0U, 0U, 0U, 0U, 0U}, mac48bitsStation{0U, 0U, 0U, 0U, 0U, 0U} {}
      char productName[12];
      char productIdentifier[9];
      char firmwareRevision[24];
      uint8_t mac48bitsAp[6];
  ...
  private:
    EmwApiBase::SoftApSettings_t accessPointSettings;
  ...
  public:
    struct Runtime_s {
      Runtime_s(void)
        ...
        , netlinkInputCallback(nullptr), netlinkInputCallbackArgPtr(nullptr)
        , scanResults(), interfaces(0U) {}
      ...
      void *netlinkInputCallbackArgPtr;
